...
import Counter from '../../lessons/useCallback/counter';

export default function UseCallbackPage({ content, ...props }) {
...
export async function getStaticProps({ params }) {
  const path = `useCallback-${params.slug}`;
